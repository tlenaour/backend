"""
Add annotations management
"""

from yoyo import step

__depends__ = {'20200831_01_wBGNT-add-users-management'}

steps = [
    step("CREATE TABLE asset(\
    ...
    step("CREATE TABLE user_project_role(\
                 ...
                 CONSTRAINT fk_role FOREIGN KEY(role) REFERENCES role_referential(role));",
